...
var
   ...
   TextStr: String;
   TmpServerDetail: String; {ska@HealthSevak: 02 May 15: to get user specified server & port if not already specified}
begin
     ...
     begin
       ...
       begin
       {begin ska@HealthSevak: 02 May 15: to get user specified server & port if not already specified, used variable and user input instead of fixed value of "BROKERSERVER,9200"}
         TmpServerDetail := 'BROKERSERVER,9200';
         TmpServerDetail :=  InputBox('VistA server details', 'No Server detail found on command line or in Registry!' +#13 + '   Please provide it in the format as ServerNameOrIP,ListnerPort:', TmpServerDetail );
         WriteRegData(HKLM, REG_SERVERS, TmpServerDetail, '');
         ServerPairs.Add(TmpServerDetail);
       {end ska@HealthSevak: 02 May 15: to get user specified server & port if not already specified, used variable and user input instead of fixed value of "BROKERSERVER,9200"}
       end;
